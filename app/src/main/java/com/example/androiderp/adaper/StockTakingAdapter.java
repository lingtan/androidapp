...
public class StockTakingAdapter extends ArrayAdapter<StockTaking>   {
//类成员变量
    private int resourceId;
    Context context;
    private int clickTemp=-1;
    List<StockTaking> data; //这个数据是会改变的，所以要有个变量来备份一下原始数据


    //构造函数，context是一个抽象类，可以理解为类的类型！
    public StockTakingAdapter(Context context, int textViewResourceId,
                              List<StockTaking> data) {
    ...
    @Override
    public StockTaking getItem(int position) {
