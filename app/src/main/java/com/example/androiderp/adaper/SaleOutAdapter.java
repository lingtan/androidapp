...
public class SaleOutAdapter extends ArrayAdapter<SalesOut>   {
//类成员变量
    private int resourceId;
    Context context;
    private int clickTemp=-1;
    List<SalesOut> data; //这个数据是会改变的，所以要有个变量来备份一下原始数据


    //构造函数，context是一个抽象类，可以理解为类的类型！
    public SaleOutAdapter(Context context, int textViewResourceId,
                          List<SalesOut> data) {
    ...
    @Override
    public SalesOut getItem(int position) {
