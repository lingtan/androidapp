...
public class CustomToobar extends Toolbar {

    public CustomToobar(Context context) {
        super(context);
    }

    public CustomToobar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomToobar(Context context, AttributeSet attrs, int defStyleAttr) {
