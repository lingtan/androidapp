...
/**
 * Created by lingtan on 2017/5/16.
 */

public class CustomToobarAdd extends Toolbar {

    public CustomToobarAdd(Context context) {
        super(context);
    }

    public CustomToobarAdd(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomToobarAdd(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        mTvMainTitleLeft = (TextView) findViewById(R.id.custom_toobar_left);
        mTvMainTitle = (TextView) findViewById(R.id.custom_toobar_midd);
        mTvMainTitleRight = (TextView) findViewById(R.id.custom_toobar_right);
    }
