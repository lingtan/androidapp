...
public class CToobarMore extends Toolbar {

    public CToobarMore(Context context) {
        super(context);
    }

    public CToobarMore(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CToobarMore(Context context, AttributeSet attrs, int defStyleAttr) {
