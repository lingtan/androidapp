...
public class CToobar extends Toolbar {

    public CToobar(Context context) {
        super(context);
    }

    public CToobar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CToobar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        mTvMainTitleLeft = (TextView) findViewById(R.id.customtoobar_left);
        mTvMainTitle = (TextView) findViewById(R.id.customtoobar_midd);
        mTvMainTitleRight = (TextView) findViewById(R.id.customtoobar_right);
    }
