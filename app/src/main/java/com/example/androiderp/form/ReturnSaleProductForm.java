...
public class ReturnSaleProductForm extends CustomSearchBase implements View.OnClickListener, AdapterView.OnItemClickListener,
...
// 设置图片大小
        ...
        screenLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent openCameraIntent = new Intent(ReturnSaleProductForm.this,CommonScanActivity.class);
...

        {
            case R.id.customtoobar_right:
                ...
                if (TextUtils.isEmpty(name.getText().toString())) {
                    Toast.makeText(ReturnSaleProductForm.this,"请选择客户",Toast.LENGTH_SHORT).show();

                }else if (TextUtils.isEmpty(number.getText().toString()))
                {
                    Toast.makeText(ReturnSaleProductForm.this,"请选择仓库",Toast.LENGTH_SHORT).show();
                }
                else if (listdatas.size()==0)
                {
                    Toast.makeText(ReturnSaleProductForm.this,"请选择产品",Toast.LENGTH_SHORT).show();
                }else if(stockCheck==0)
                {
                    Toast.makeText(ReturnSaleProductForm.this,"库存不足,不能保存",Toast.LENGTH_LONG).show();
                }else

                {
                    ...
                    salesOut.save();
                    Toast.makeText(ReturnSaleProductForm.this,"新增成功",Toast.LENGTH_SHORT).show();
            ...
            case R.id.stockin_layout:
                ...
                if(stockList.size()>0) {
                    ...
                    Intent intentstock=new Intent(ReturnSaleProductForm.this, StockIntentListview.class);
            ...
            case R.id.stockout_layout:
                Intent intentcustom=new Intent(ReturnSaleProductForm.this, SelectCustomListView.class);
            ...
            case R.id.customtoobar_left:
                if(listdatas.size()>0)
                {
                    AlertDialog.Builder dialog=new AlertDialog.Builder(ReturnSaleProductForm.this);
                    dialog.setTitle("提示");
                    ...
                    dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ReturnSaleProductForm.this.finish();
                        }
                    });
            ...
            case R.id.businessdata_layout:
                ...
                DatePickerDialog dialog=new DatePickerDialog(ReturnSaleProductForm.this, 0,listener,year,month,day);//后边三个参数为显示dialog时默认的日期，月份从0开始，0-11对应1-12个月
            ...
            case R.id.billnumber_layout:
                Intent intentconsignment=new Intent(ReturnSaleProductForm.this, ConsignmentListview.class);
            ...
            case R.id.saleproduct_add:
                Intent intentbadge=new Intent(ReturnSaleProductForm.this, ProductBadgeListView.class);
    ...
    private void showPopupWindow(final List<PopuMenuDataStructure> popuMenuData) {
        ...
        common.PopupWindow(ReturnSaleProductForm.this, dm, popuMenuData);
        common.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view,
                ...
                {
                    intent = new Intent(ReturnSaleProductForm.this, ReturnSaleProductForm.class);
            ...
            case 5:
                if(resultCode==RESULT_OK) {
                   ...
                   if(productList.size()==0){
                       Toast.makeText(ReturnSaleProductForm.this,"找不到条码为"+data.getStringExtra("scanResult")+"商品",Toast.LENGTH_LONG).show();
                   }else {
                      //产品重复就累加，否则就添加。
...

                       {
                           ...
                           {
                               Toast.makeText(ReturnSaleProductForm.this,"库存不足，实际库存为："+df.format(quantity),Toast.LENGTH_LONG).show();
                               stockCheck=0;
                           }else {
                               stockCheck=1;
                           }
                       ...
                       adapter = new SaleProductListViewAdapter(ReturnSaleProductForm.this, R.layout.saleproduct_item, listdatas);
    ...
    private void showStockWindow() {
        ...
        common.PopupWindow(ReturnSaleProductForm.this, dm, popuMenuDatas);
        common.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
