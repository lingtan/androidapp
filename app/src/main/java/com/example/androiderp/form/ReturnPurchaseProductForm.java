...
public class ReturnPurchaseProductForm extends CustomSearchBase implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    public void onClick(View v) {
...

        {
            ...
            case R.id.saleproduct_add:
                Intent intentbadge=new Intent(ReturnPurchaseProductForm.this, ProductBadgeListView.class);
