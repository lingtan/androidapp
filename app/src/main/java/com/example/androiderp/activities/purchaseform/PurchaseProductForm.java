...
public class PurchaseProductForm extends CSearchBase implements View.OnClickListener, AdapterView.OnItemClickListener,
...
// 设置图片大小
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent=new Intent(PurchaseProductForm.this,ShoppingScrennForm.class);
    ...
    public void onClick(View v) {
...

        {
            ...
            case R.id.stockout_layout:
                Intent intentcustom=new Intent(PurchaseProductForm.this, SupplierSelectView.class);
            ...
            case R.id.balanceaccount_layout:
                Intent intentBalance=new Intent(PurchaseProductForm.this, BalanceAccountView.class);
            ...
            case R.id.billnumber_layout:
                Intent intentconsignment=new Intent(PurchaseProductForm.this, ConsignmentView.class);
            ...
            case R.id.saleproduct_add:
                Intent intentbadge=new Intent(PurchaseProductForm.this, ProductSelectView.class);
