...
public class ProductAppropriationView extends CSearchBase implements View.OnClickListener, AppropriationBadgeAdapter.Callback{
    ...
    public void iniView(){
        ...
        intent= new Intent(ProductAppropriationView.this, AppropriationShoppingForm.class);
        ...
        rightListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            leftAdapter = new CommonAdapter(ProductAppropriationView.this, R.layout.custom_item, categorylist);
        ...
        account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(productShoppingList !=null& productShoppingList.size()!=0){
                    Intent intentdata=new Intent(ProductAppropriationView.this, SaleForm.class);
                    ...
                    ProductAppropriationView.this.finish();
                }
            }
        });
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(productSearch !=null) {
            ...
            rightAdapter = new AppropriationBadgeAdapter(ProductAppropriationView.this, R.layout.appropriation_badge_item, productSearch,this);
            ...
            case 1:
                if(resultCode==RESULT_OK)
                {
                    ...
                    for (int i = 0; i < productShoppingList.size(); i++) {
                        ...
                        {
                            Toast.makeText(ProductAppropriationView.this,"调出仓库数量不足，实际库存为："+df.format(quantity),Toast.LENGTH_SHORT).show();
                        }
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.custom_toobar_right:
                Intent intentnew= new Intent(ProductAppropriationView.this, ProductForm.class);
            ...
            case R.id.customtoobar_screen:
                Intent openCameraIntent=new Intent(ProductAppropriationView.this,CommonScanActivity.class);
