...
import com.example.androiderp.activities.accountsform.AccountsForm;
        ...
        switch (direction) {
            case MenuItem.DIRECTION_RIGHT:
                switch (buttonPosition) {
                    ...
                    case 1:
                        AlertDialog.Builder dialog=new AlertDialog.Builder(AccountsView.this);
                        dialog.setTitle("提示");
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.custom_toobar_right:
                Intent cate = new Intent(AccountsView.this, AccountsForm.class);
