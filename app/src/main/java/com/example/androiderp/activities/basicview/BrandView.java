...
import com.example.androiderp.activities.basicfrom.BrandForm;
...
import com.example.androiderp.interfaces.BasicInterFace;
...
public class BrandView extends CSearchBase implements BasicInterFace, View.OnClickListener,
    ...
    public void getHttpData(final PostUserData postPostUserData) {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(BrandView.this, "网络连接失败", Toast.LENGTH_SHORT).show();
        ...
        switch (direction) {
            case MenuItem.DIRECTION_RIGHT:
                switch (buttonPosition) {
                    case 0:
                        Intent intent = new Intent(BrandView.this, BrandForm.class);
                    ...
                    case 1:
                        AlertDialog.Builder dialog = new AlertDialog.Builder(BrandView.this);
                        dialog.setTitle("提示");
                        ...
                        dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (productList.size() > 0) {
                                    ...
                                    Toast.makeText(BrandView.this, "业务已经发生不能删除", Toast.LENGTH_SHORT).show();
                                } else {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.custom_toobar_right:
                Intent cate = new Intent(BrandView.this, BrandForm.class);
            ...
            case 1:
                if (resultCode == RESULT_OK) {
                    ...
                    if (editDate != null) {
                        ...
                        adapter = new CommonListViewAdapter(BrandView.this, R.layout.custom_item, postUserDataList);
                        adapter.setSeclection(indexPositon);
                        listView.setAdapter(adapter);
                        Toast.makeText(BrandView.this, "操作成功", Toast.LENGTH_SHORT).show();
                    }
    ...
    private TextWatcher textWatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            searchItem(search.getText().toString().trim());
