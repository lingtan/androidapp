...
public class SaleReturnForm extends CSearchBase implements View.OnClickListener, AdapterView.OnItemClickListener,
...
// 设置图片大小
        ...
        screenLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent openCameraIntent = new Intent(SaleReturnForm.this,CommonScanActivity.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent=new Intent(SaleReturnForm.this,ShoppingScrennForm.class);
...

        {
            case R.id.customtoobar_right:
                ...
                if (TextUtils.isEmpty(name.getText().toString())) {
                    Toast.makeText(SaleReturnForm.this,"请选择客户",Toast.LENGTH_SHORT).show();

                }else if (TextUtils.isEmpty(number.getText().toString()))
                {
                    Toast.makeText(SaleReturnForm.this,"请选择仓库",Toast.LENGTH_SHORT).show();
                }
                else if (listdatas.size()==0)
                {
                    Toast.makeText(SaleReturnForm.this,"请选择产品",Toast.LENGTH_SHORT).show();
                }else if(stockCheck==0)
                {
                    Toast.makeText(SaleReturnForm.this,"库存不足,不能保存",Toast.LENGTH_LONG).show();
                }else

                {
                    ...
                    salesOut.save();
                    Toast.makeText(SaleReturnForm.this,"新增成功",Toast.LENGTH_SHORT).show();
            ...
            case R.id.stockout_layout:
                Intent intentcustom=new Intent(SaleReturnForm.this, CustomSelectView.class);
            ...
            case R.id.customtoobar_left:
                if(listdatas.size()>0)
                {
                    AlertDialog.Builder dialog=new AlertDialog.Builder(SaleReturnForm.this);
                    dialog.setTitle("提示");
            ...
            case R.id.businessdata_layout:
                ...
                DatePickerDialog dialog=new DatePickerDialog(SaleReturnForm.this, 0,listener,year,month,day);//后边三个参数为显示dialog时默认的日期，月份从0开始，0-11对应1-12个月
            ...
            case R.id.saleproduct_add:
                Intent intentbadge=new Intent(SaleReturnForm.this, ProductSelectView.class);
    ...
    private void showPopupWindow(final List<PopuMenuDataStructure> popuMenuData) {
        ...
        common.PopupWindow(SaleReturnForm.this, dm, popuMenuData);
        common.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view,
                ...
                {
                    intent = new Intent(SaleReturnForm.this, SaleReturnForm.class);
            ...
            case 5:
                if(resultCode==RESULT_OK) {
                   ...
                   if(productList.size()==0){
                       Toast.makeText(SaleReturnForm.this,"找不到条码为"+data.getStringExtra("scanResult")+"商品",Toast.LENGTH_LONG).show();
                   }else {
                      //产品重复就累加，否则就添加。
...

                       {
                           ...
                           {
                               Toast.makeText(SaleReturnForm.this,"库存不足，实际库存为："+df.format(quantity),Toast.LENGTH_LONG).show();
                               stockCheck=0;
                           }else {
                               stockCheck=1;
                           }
                       ...
                       adapter = new SaleProductListViewAdapter(SaleReturnForm.this, R.layout.saleproduct_item, listdatas);
    ...
    private void showStockWindow() {
        ...
        common.PopupWindow(SaleReturnForm.this, dm, popuMenuDatas);
        common.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
