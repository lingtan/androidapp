...
public class SupplierView extends CSearchBase implements View.OnClickListener {
    ...
    public void iniView(){
        ...
        intent=new Intent(SupplierView.this,SupplierForm.class);
        ...
        if(commonAdapterDataList.size()!=0) {
                 ...
                 adapter = new CommonAdapter(SupplierView.this, R.layout.custom_item, commonAdapterDataList);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(commonAdapterDataSearch !=null) {
            adapter = new CommonAdapter(SupplierView.this, R.layout.custom_item, commonAdapterDataSearch);
            listView.setAdapter(adapter);
        }
    }
