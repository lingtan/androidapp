...
import com.example.androiderp.bean.GroupMark;
...
public class TallyExpandableView extends CSearchBase implements View.OnClickListener {
    ...
    public void iniView(){
        ...
        intentEdit= new Intent(TallyExpandableView.this, TallyAccountsEntyView.class);
        ...
        if(accountsList.size()!=0 && balanceAccountList.size()!=0) {
                 ...
                 adapter = new ExpandableListViewAdapter(TallyExpandableView.this,groupItemList, item_list);
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.custom_toobar_left:
                TallyExpandableView.this.finish();
                break;

            case R.id.custom_toobar_right:
                intentAdd = new Intent(TallyExpandableView.this, TallyForm.class);
