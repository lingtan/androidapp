...
public class SupplierMoreView extends CSearchBase implements View.OnClickListener {
    ...
    public void iniView(){
        ...
        rightListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view,
             ...
             Intent   intent= new Intent(SupplierMoreView.this, SupplierForm.class);
            ...
            leftAdapter = new CommonAdapter(SupplierMoreView.this, R.layout.custom_item, categorylist);
            leftAdapter.setSeclection(0);
            leftListView.setAdapter(leftAdapter);
            rightAdapter = new CommonAdapter(SupplierMoreView.this, R.layout.custom_item, commonAdapterDataList);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(commonAdapterDataSearch !=null) {
            rightAdapter = new CommonAdapter(SupplierMoreView.this, R.layout.custom_item, commonAdapterDataSearch);
            rightListView.setAdapter(rightAdapter);
        }
    }
