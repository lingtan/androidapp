...
public class ReturnPurchaseProductForm extends CSearchBase implements View.OnClickListener, AdapterView.OnItemClickListener,
...
// 设置图片大小
        ...
        screenLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent openCameraIntent = new Intent(ReturnPurchaseProductForm.this,CommonScanActivity.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent=new Intent(ReturnPurchaseProductForm.this,ShoppingScrennForm.class);
...

        {
            case R.id.customtoobar_right:
                if (TextUtils.isEmpty(name.getText().toString())) {
                    Toast.makeText(ReturnPurchaseProductForm.this,"请选择客户",Toast.LENGTH_SHORT).show();

                }else if (TextUtils.isEmpty(number.getText().toString()))
                {
                    Toast.makeText(ReturnPurchaseProductForm.this,"请选择仓库",Toast.LENGTH_SHORT).show();
                }
                else if (listdatas.size()==0)
                {
                    Toast.makeText(ReturnPurchaseProductForm.this,"请选择产品",Toast.LENGTH_SHORT).show();
                }else
            ...
            case R.id.stockout_layout:
                Intent intentcustom=new Intent(ReturnPurchaseProductForm.this, SupplierSelectView.class);
            ...
            case R.id.businessdata_layout:
                ...
                DatePickerDialog dialog=new DatePickerDialog(ReturnPurchaseProductForm.this, 0,listener,year,month,day);//后边三个参数为显示dialog时默认的日期，月份从0开始，0-11对应1-12个月
            ...
            case R.id.billnumber_layout:
                Intent intentconsignment=new Intent(ReturnPurchaseProductForm.this, ConsignmentView.class);
            ...
            case R.id.saleproduct_add:
                Intent intentbadge=new Intent(ReturnPurchaseProductForm.this, ProductSelectView.class);
    ...
    private void showPopupWindow(final List<PopuMenuDataStructure> popuMenuData) {
        ...
        common.PopupWindow(ReturnPurchaseProductForm.this, dm, popuMenuData);
        common.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view,
                ...
                {
                    intent = new Intent(ReturnPurchaseProductForm.this, SupplierForm.class);
            ...
            case 5:
                if(resultCode==RESULT_OK) {
                   ...
                   if(productList.size()==0){
                       Toast.makeText(ReturnPurchaseProductForm.this,"找不到条码为"+data.getStringExtra("scanResult")+"商品",Toast.LENGTH_LONG).show();
                   }else {
                       ...
                       adapter = new SaleProductListViewAdapter(ReturnPurchaseProductForm.this, R.layout.saleproduct_item, listdatas);
    ...
    private void showStockWindow() {
        ...
        common.PopupWindow(ReturnPurchaseProductForm.this, dm, popuMenuDatas);
        common.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
