...
public class PurchaseSearchView extends CSearchBase implements View.OnClickListener {
    ...
    public void iniView(){
        ...
        intent= new Intent(PurchaseSearchView.this, PurchaseEntyView.class);
        ...
        if(salesOutList.size()!=0) {
                 ...
                 adapter = new SaleOutAdapter(PurchaseSearchView.this,R.layout.saleout_item, salesOutList);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(salesOutSearch !=null) {
            adapter = new SaleOutAdapter(PurchaseSearchView.this, R.layout.saleout_item, salesOutSearch);
            listView.setAdapter(adapter);
        }
    }
