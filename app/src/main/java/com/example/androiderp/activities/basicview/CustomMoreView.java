...
public class CustomMoreView extends CSearchBase implements View.OnClickListener {
    ...
    public void iniView(){
        ...
        intent= new Intent(CustomMoreView.this, CustomForm.class);
        ...
        rightListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            leftAdapter = new CommonAdapter(CustomMoreView.this, R.layout.custom_item, categorylist);
            leftAdapter.setSeclection(0);
            leftListView.setAdapter(leftAdapter);
            rightAdapter = new CommonAdapter(CustomMoreView.this, R.layout.custom_item, commonAdapterDataList);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(commonAdapterDataSearch !=null) {
            rightAdapter = new CommonAdapter(CustomMoreView.this, R.layout.custom_item, commonAdapterDataSearch);
            rightListView.setAdapter(rightAdapter);
        }
    }
