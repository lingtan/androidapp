...
import com.example.androiderp.activities.basicfrom.SupplierCategoryForm;
...
public class SupplierCategoryView extends CSearchBase implements View.OnClickListener,
    ...
    public void iniView(){
        ...
        if(listdatas.size()!=0) {
                 ...
                 adapter = new CommonListViewAdapter(SupplierCategoryView.this, R.layout.custom_item, listdatas);
        ...
        switch (direction) {
            case MenuItem.DIRECTION_RIGHT:
                switch (buttonPosition) {
                    case 0:
                        Intent intent=new Intent(SupplierCategoryView.this,SupplierCategoryForm.class);
                    ...
                    case 1:
                        AlertDialog.Builder dialog=new AlertDialog.Builder(SupplierCategoryView.this);
                        dialog.setTitle("提示");
                        dialog.setMessage("您确认要删除该分类？");
                        dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                DataStructure.deleteAll(SupplierCategory.class,"name = ?",listdatas.get(itemPosition - listView.getHeaderViewsCount()).getName().toString());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent=new Intent(SupplierCategoryView.this,ProductCategoryForm.class);
    ...
    public void  searchItem(String name) {
        ...
        supplierCategoryList =DataStructure.where("name like ?","%" + name + "%").find(SupplierCategory.class);
        for(SupplierCategory supplierCategory: supplierCategoryList)
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.custom_toobar_left:
                ...
                setResult(RESULT_OK,intent);
                SupplierCategoryView.this.finish();
                break;
            ...
            case R.id.custom_toobar_right:
                Intent cate = new Intent(SupplierCategoryView.this, SupplierCategoryForm.class);
