...
public class SaleEntyView extends CSearchBase implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    public void iniView() {
        ...
        showStockWindow();
        intentback= new Intent(SaleEntyView.this, SaleEntyView.class);
...
// 设置图片大小
    ...
    private void  formInit()
    {
        ...
        if(customid!=null) {
          ...
          for(SalesOutEnty salesOutEnty:salesOutEntyList) {
            ...
            adapter = new SaleProductListViewAdapter(SaleEntyView.this, R.layout.saleproduct_item, commonAdapterDataList);
    ...
    private void showPopupWindow(final List<PopBean> popuMenuData) {
        ...
        common.PopupWindow(SaleEntyView.this, dm, popuMenuData);
    ...
    private void showStockWindow() {
        ...
        common.PopupWindow(SaleEntyView.this, dm, popuMenuDatas);
        common.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
