...
import com.example.androiderp.bean.Brand;
...
public class BrandForm extends AppCompatActivity implements BasicInterFace, View.OnClickListener {
    ...
    @Override
    public void getHttpData( PostUserData postPostUserData) {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(BrandForm.this, "网络连接失败", Toast.LENGTH_SHORT).show();
                    ...
                    public void run() {
                        try {
                            ...
                            if (returnUserData.getResult() > 0) {
                                ...
                                Toast.makeText(BrandForm.this, "操作失败", Toast.LENGTH_SHORT).show();
                            }
                        }catch (Exception e)
                        {

                            Toast.makeText(BrandForm.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                        }
