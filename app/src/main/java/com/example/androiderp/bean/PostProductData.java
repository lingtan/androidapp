...
/**
 * Created by lingtan on 2017/10/20.
 */

public class PostProductData implements Parcelable{
    ...
    public static final Parcelable.Creator<PostProductData> CREATOR=new Parcelable.Creator<PostProductData>(){
        @Override
        public PostProductData createFromParcel(Parcel source) {
            PostProductData postUserData =new PostProductData();
            ...
            postUserData.servlet=source.readString();
            return postUserData;
        }

        @Override
        public PostProductData[] newArray(int size) {
            return new PostProductData[size];
        }
    };
}
