...
public class InventorySearchListView extends CustomSearchBase implements View.OnClickListener, AppropriationBadgeAdapter.Callback{
    ...
    public void iniView(){
        ...
        intent= new Intent(InventorySearchListView.this, InventoryEntyList.class);
        ...
        if(productList.size()!=0) {
                 ...
                 adapter = new AppropriationBadgeAdapter(InventorySearchListView.this, R.layout.appropriation_badge_item, productList,this);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(commonDataStructureSearch !=null) {
            adapter = new AppropriationBadgeAdapter(InventorySearchListView.this, R.layout.appropriation_badge_item, commonDataStructureSearch,this);
            listView.setAdapter(adapter);
        }
    }
    ...
    private void showPopupWindow(final List<PopuMenuDataStructure> popuMenuData) {
        ...
        common.PopupWindow(InventorySearchListView.this, dm, popuMenuData);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                Intent openCameraIntent = new Intent(InventorySearchListView.this,CommonScanActivity.class);
