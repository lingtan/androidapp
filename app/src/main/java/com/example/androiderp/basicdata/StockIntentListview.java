...
public class StockIntentListview extends CustomSearchBase implements View.OnClickListener,
    ...
    public void iniView(){
        ...
        if(listdatas.size()!=0) {
             if(categoryid!=null) {
                 ...
                 adapter = new CommonListViewAdapter(StockIntentListview.this, R.layout.custom_item, listdatas);
        ...
        switch (direction) {
            case MenuItem.DIRECTION_RIGHT:
                switch (buttonPosition) {
                    case 0:
                        Intent intent=new Intent(StockIntentListview.this,ProductCategoryForm.class);
                    ...
                    case 1:
                        AlertDialog.Builder dialog=new AlertDialog.Builder(StockIntentListview.this);
                        dialog.setTitle("提示");
                        ...
                        dialog.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                {
                                    Toast.makeText(StockIntentListview.this,"已经有业务发生，不能删除",Toast.LENGTH_SHORT).show();
                                    ...
                                    AlertDialog.Builder dialogOK = new AlertDialog.Builder(StockIntentListview.this);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(String name) {
        if(commonDataStructureSearch !=null) {
            ...
            adapter = new CommonListViewAdapter(StockIntentListview.this, R.layout.custom_item, commonDataStructureSearch);
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.custom_toobar_left:
                StockIntentListview.this.finish();
                break;
            ...
            case R.id.custom_toobar_right:
                Intent cate = new Intent(StockIntentListview.this, StockForm.class);
