...
public class SaleOutListView extends CustomSearchBase implements View.OnClickListener {
    ...
    public void iniView(){
        ...
        customSearch.setHint("销售流水 | 输入客户");
        ...
        if(salesOutList.size()!=0) {
                 ...
                 adapter = new SaleOutAdapter(SaleOutListView.this, R.layout.saleout_item, salesOutList);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(salesOutSearch !=null) {
            adapter = new SaleOutAdapter(SaleOutListView.this, R.layout.saleout_item, salesOutSearch);
            listView.setAdapter(adapter);
        }
    }
