...
import com.example.androiderp.form.BalanceAccountForm;
...
public class BalanceAccountListView extends CustomSearchBase implements View.OnClickListener,
    ...
    public void iniView(){
        ...
        if(listdatas.size()!=0) {
                 adapter = new CommonListViewAdapter(BalanceAccountListView.this, R.layout.custom_item, listdatas);
        ...
        switch (direction) {
            case MenuItem.DIRECTION_RIGHT:
                switch (buttonPosition) {
                    ...
                    case 1:
                        AlertDialog.Builder dialog=new AlertDialog.Builder(BalanceAccountListView.this);
                        dialog.setTitle("提示");
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.custom_toobar_left:
                ...
                setResult(RESULT_OK,intent);
                BalanceAccountListView.this.finish();
                break;
            ...
            case R.id.custom_toobar_right:
                Intent cate = new Intent(BalanceAccountListView.this, BalanceAccountForm.class);
