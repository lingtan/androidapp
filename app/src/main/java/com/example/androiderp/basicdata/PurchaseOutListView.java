...
public class PurchaseOutListView extends CustomSearchBase implements View.OnClickListener {
    ...
    public void iniView(){
        ...
        customSearch.setHint("采购流水 | 输入供应商");
        salesOutList =DataSupport.where("billtype =?","1").find(SalesOut.class);
        intentEdit = new Intent(PurchaseOutListView.this, PurchaseOutEntyList.class);
        ...
        if(salesOutList.size()!=0) {
                 ...
                 adapter = new SaleOutAdapter(PurchaseOutListView.this, R.layout.saleout_item, salesOutList);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(salesOutSearch !=null) {
            adapter = new SaleOutAdapter(PurchaseOutListView.this, R.layout.saleout_item, salesOutSearch);
            listView.setAdapter(adapter);
        }
    }
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.custom_toobar_left:
                PurchaseOutListView.this.finish();
                break;

            case R.id.custom_toobar_right:
                intentadd = new Intent(PurchaseOutListView.this, PurchaseProductForm.class);
