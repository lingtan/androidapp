...
public class InventoryEntyList extends CustomSearchBase implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    public void iniView() {
        ...
        intentBack= new Intent(InventoryEntyList.this, InventoryEntyList.class);
...
// 设置图片大小
    ...
    {  quantityCount=0;
        ...
        if(productId !=null) {
          ...
          for(Stock stock:stockList) {
            ...
            adapter = new AppropriationListViewAdapter(InventoryEntyList.this, R.layout.saleproduct_item, listdatas);
    ...
    private void showPopupWindow(final List<PopuMenuDataStructure> popuMenuData) {
        ...
        common.PopupWindow(InventoryEntyList.this, dm, popuMenuData);
