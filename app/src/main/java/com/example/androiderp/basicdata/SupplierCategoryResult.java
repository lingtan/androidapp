...
public class SupplierCategoryResult extends CustomSearchBase implements View.OnClickListener {
    ...
    private String categoryid,edit;
    ...
    public void iniView(){
        ...
        plistView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view,
                ...
                Intent intent=new Intent(SupplierCategoryResult.this,SupplierForm.class);
               ...
               setResult(RESULT_OK,intent);
                ...
                pposition=position;
                SupplierCategoryResult.this.finish();
        ...
        if(listdatas.size()!=0) {
             if(categoryid!=null) {
                 ...
                 adapter = new CommonAdapter(SupplierCategoryResult.this, R.layout.custom_item, listdatas);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(String name) {
        if(searchdatas!=null) {
            ...
            adapter = new CommonAdapter(SupplierCategoryResult.this, R.layout.custom_item, searchdatas);
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            case R.id.custom_toobar_left:
                Intent cate = new Intent(SupplierCategoryResult.this, SupplierCategoryForm.class);
