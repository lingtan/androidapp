...
public class ProductStockTakingListView extends CustomSearchBase implements View.OnClickListener, AppropriationBadgeAdapter.Callback{
    ...
    public void iniView(){
        ...
        rightListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            leftAdapter = new CommonAdapter(ProductStockTakingListView.this, R.layout.custom_item, categorylist);
        ...
        account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(productShoppingList !=null& productShoppingList.size()!=0){
                    Intent intentdata=new Intent(ProductStockTakingListView.this, SaleProductForm.class);
                    ...
                    ProductStockTakingListView.this.finish();
                }
            }
        });
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(productSearch !=null) {
            ...
            rightAdapter = new AppropriationBadgeAdapter(ProductStockTakingListView.this, R.layout.appropriation_badge_item, productSearch,this);
    ...
    public void onClick(View v) {
        switch(v.getId())
        {
            ...
            case R.id.custom_toobar_right:
                Intent intentnew= new Intent(ProductStockTakingListView.this, ProductForm.class);
            ...
            case R.id.customtoobar_screen:
                Intent openCameraIntent=new Intent(ProductStockTakingListView.this,CommonScanActivity.class);
