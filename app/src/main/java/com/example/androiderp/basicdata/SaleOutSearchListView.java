...
public class SaleOutSearchListView extends CustomSearchBase implements View.OnClickListener {
    ...
    public void iniView(){
        ...
        intent= new Intent(SaleOutSearchListView.this, SaleOutEntyList.class);
        ...
        if(salesOutList.size()!=0) {
                 ...
                 adapter = new SaleOutAdapter(SaleOutSearchListView.this,R.layout.saleout_item, salesOutList);
...
//adapter刷新,重写Filter方式会出现BUG.
    public void updateLayout(Object[] obj) {
        if(salesOutSearch !=null) {
            adapter = new SaleOutAdapter(SaleOutSearchListView.this, R.layout.saleout_item, salesOutSearch);
            listView.setAdapter(adapter);
        }
    }
    ...
    private void showPopupWindow(final List<PopuMenuDataStructure> popuMenuData) {
        ...
        common.PopupWindow(SaleOutSearchListView.this, dm, popuMenuData);
